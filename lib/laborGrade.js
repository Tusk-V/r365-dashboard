...
export const getDailyLaborGrade = (day, forecastVariance) => {
  ...
  if (composite >= 60) return { letter: 'C', color: 'text-amber-300', bg: 'bg-amber-500/20 border-amber-600', score: composite };
  if (composite >= 40) return { letter: 'D', color: 'text-orange-300', bg: 'bg-orange-500/20 border-orange-600', score: composite };
