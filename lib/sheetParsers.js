...
export const parseSheetData = (rows) => {
  ...
  for (let i = 0; i < rows.length; i++) {
    ...
    const scheduledLaborPercent = actualSales > 0 ? (scheduledHours * laborCostPerHour) / actualSales * 100 : 0;
    const scheduledLaborVariance = laborPercent - scheduledLaborPercent; // Act% - Sch%
