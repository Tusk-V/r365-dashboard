...
// Can the actor moderate/announce in a channel?
// company → super-admin/Owner/FOM only; market → those plus a manager of that
// market; location → those plus a manager of that store (market or store mgr).
