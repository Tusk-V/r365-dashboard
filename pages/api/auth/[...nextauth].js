...
// Emails that match the rancherscustard.com domain but are explicitly
// denied. Checked case-insensitively before any user record is created.
...
export const authOptions = {
  ...
  callbacks: {
    async signIn({ user, account, profile }) {
      ...
      // Explicit blocklist for in-domain emails we've decided to deny.
      // Also purge any pre-existing record so they don't linger in admin/users.
